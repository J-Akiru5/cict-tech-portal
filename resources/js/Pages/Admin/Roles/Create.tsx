        ...
        <AdminLayout>
            ...
            <div className="p-6 lg:p-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-white/60">Define a new role with specific permissions</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="max-w-4xl">
                    <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm mb-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-white/40">Use lowercase with hyphens (e.g., content-manager)</p>
                        </div>
                    </div>
